...
function ListView(props){
                ...
                <div key={key} className="columns">
                    ...
                    <div className="column">
                        <p className="is-6 has-text-right">
                            ...
                            <NumberFormat thousandSeparator={true} prefix={''} displayType={'text'} value={sum} />
                        </p>
                    </div>
                </div>
        );
    ...
    const locationElement = locationArray.map(location=>{
        const{
            id,country_code,country,province,latest:{confirmed}
        }=location;
        ...
        return(
            <div key={`${id}-${country_code}`}  className={locationClass} 
            ...
            <div className="columns">
                ...
                <div className="column">
                    <p className="is-6 has-text-right">
                        <NumberFormat thousandSeparator={true} prefix={''} displayType={'text'} value={confirmed} />
                    </p>
                </div>
            </div>
            </div>
